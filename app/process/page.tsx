...
<p>월 코칭은 여러 회를 묶어 신청하므로 시간당 금액이 단독 코칭보다 낮습니다. 취소 시에는 실제 진행한 시간에 해당 금액을 적용합니다.</p>
<div className="table-scroll"><table className="policy-table refund-table"><caption>부가세를 포함한 환불 계산 기준</caption><thead><tr><th scope="col">코칭 · 시간당 비용</th><th scope="col">환불 예시</th></tr></thead><tbody><tr><th scope="row">월 코칭<span className="refund-hourly">시간당<br/>165,000원</span></th><td><span className="refund-scenario">8시간 중 2시간 진행 후 취소</span><div className="refund-calculation"><span>132만 원 − </span><span>(2시간 × 165,000원)</span><strong>= 990,000원 환불</strong></div></td></tr><tr><th scope="row">단독 코칭<span className="refund-hourly">시간당<br/>220,000원</span></th><td><span className="refund-scenario">2시간 중 1시간 진행 후 취소</span><div className="refund-calculation"><span>44만 원 − </span><span>(1시간 × 220,000원)</span><strong>= 220,000원 환불</strong></div></td></tr></tbody></table></div>
...
<FAQ subset={[7,8,2,3,4,5,6,0,1]}/><ConsultCTA description="단독 코칭과 월 코칭 중 무엇이 맞을지, 하시려는 일을 듣고 안내해드립니다."/>
</main>}
