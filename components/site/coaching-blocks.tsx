...
export function Method({showSessionExample=false,showProcessLink=true,showProjectEstimate=false}:{showSessionExample?:boolean;showProcessLink?:boolean;showProjectEstimate?:boolean}={}) {
