...
export function WorkShowcase() {
  ...
  return <section ref={ref} className="work-showcase" data-scene={scene}>
    ...
    <div className="container work-inner">
      <Reveal><div className="work-heading"><div><p className="eyebrow">고객 웹사이트의 실제 데이터</p><h2>숫자로<br/>확인하실 수 있습니다.</h2></div><p>GA4의 AI 유입과 구글 서치콘솔 기록을<br/>확인 가능한 범위 안에서 설명합니다.</p></div></Reveal>
