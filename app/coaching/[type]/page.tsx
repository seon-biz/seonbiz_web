...
<section className="container related-case"><p>{isShop?'실제 상품 정보 정비와 검색 기록을 확인하세요.':'원고를 영상으로 옮긴 실제 제작 과정을 확인하세요.'}</p><a href={isShop?'/cases/search-records':'/cases/content-workflow'} className="text-link">{isShop?'식품 쇼핑몰 작업 사례 보기':'짧은 영상 제작 사례 보기'}<ArrowUpRight size={18}/></a></section>
